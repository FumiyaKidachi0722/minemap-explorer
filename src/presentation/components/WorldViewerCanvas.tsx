...
import { loadBlueMapChunk } from '@/infrastructure/blueMap';
import type { Block } from '@/domain/block';

// Displays BlueMap chunk data in a simple first-person viewer.
...
export default function WorldViewerCanvas() {
  ...
  useEffect(() => {
    ...
    async function loadBlocks() {
      blocks = await loadBlueMapChunk('/bluemap/chunk0.prbm.gz.b64');
      requestAnimationFrame(drawScene);
    }
